...
try {
	...
	include 'conexao.php';
	$stmt = $conexao->prepare('select * from produtos where codcategoria=7');
	$stmt->execute();
}   
	catch(Exception $e) 
{
...
<div class="container">
<h3>Rações e Brinquedos para seu Animal</h3>
<hr class="my-4">
 ...
 <div class="col-md-3 mb-4 ml-auto mr-auto">
      <div class="card h-100" id="borda">
        <div class="card-header">
           <a href="produto.php?codigo=<?php echo $produtos->codigo ?>"><img class="card-img-top" src="<?php echo $produtos->imagem ?>"></a>        </div>
        <div class="card-body">
